...
Beispiel DGL: $u-4\dot{u}=3e+4\dot{e}+\ddot{e} \ \laplace \ U(1-4s)=E(3+4s+s^2) \qquad \frac{U}{E}=\frac{3+4s+s^2}{1-4s}$
...
Die UTF in ist nicht minimal; eine vollständig gekürzte UTF dagegen heisst minimal. \\
