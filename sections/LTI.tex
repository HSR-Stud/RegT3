...
Gleichungssystem mit 5 Gleichungen und 6 Signalen. Das Eliminieren der 4 internen Signale $(U_{C}, U_{R}, U_{L}, I)$ fällt leichter. Weniger Anfangsbedingungen nötig als wenn nur als 1 Gleichung im Zeit bereich in den Bildbereich transformiert wird.\\
...
In der faktorisierten Form äussert sich dies durch eine Pol-/Nullstellenkürzung; in der PBZ ist der entsprechende Koeffizient $c_{2}$ = 0. Die UTF in ist nicht minimal; eine vollständig gekürzte UTF dagegen heisst minimal. \\
...
Merke: Nichtminimalphasige Systeme holen in falsche Seite aus. Wert der Sprungantwort wechselt das Vorzeichen.
