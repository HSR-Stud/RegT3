...
\subsection{Laplace-Transformation \buchSeite{20} \buch{63}}
	...
	\subsection{Transformation einer periodischen Funktion \buchSeite{24} \buch{74}}
		\[ F(s) = F_0(s)\cdot\dfrac{1}{1 - e^{-sT}} \qquad \text{mit } F_0(s) \text{ als eine Periode}\] 


\newpage
	\subsubsection{Laplace-Tabelle \buchSeite{21} \buch{85ff}}
	\begin{multicols}{2}
		\begin{center}
			\begin{tabular}{|lcc|}
				\hline
...
\subsubsection{minimalphasig \buchSeite{43} \buch{149}}
...
\subsection{Partialbruchzerlegung (PBZ) \buchSeite{31} \buch{78}}
...
\clearpage
\subsection{Stabilitätskriterien, Routh-Kriterium \buchSeite{38} \buch{240}}
...
\subsection{Blockdiagramm Algebra \buch{40}}
\begin{center}
...
\subsection{Analog Rechner \buchSeite{57} \buch{323}}
	\begin{center}
	\includegraphics[width=0.7\textwidth]{./images/AnalogRechner}
	\end{center}

\subsection{Bodediagramm \buch{114, 291} und Nyquistdiagramm \buch{245} \buchSeite{63} }
...
\begin{itemize}
	...
	ein instabiles.
\end{itemize}
\subsubsection{Vereinfachtes Nyquistkriterium \buch{246}}
